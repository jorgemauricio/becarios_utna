...
def creardia1():
    archivo=open('/home/jackie/Documentos/becarios_utna/ejercicios/Resultados/Dia1.csv','w')
    archivo.close()
def creardia2():
    archivo=open('/home/jackie/Documentos/becarios_utna/ejercicios/Resultados/Dia2.csv','w')
    archivo.close()
def creardia3():
    archivo=open('/home/jackie/Documentos/becarios_utna/ejercicios/Resultados/Dia3.csv','w')
    archivo.close()
def creardia4():
    archivo=open('/home/jackie/Documentos/becarios_utna/ejercicios/Resultados/Dia4.csv','w')
    archivo.close()
def creardia5():
    archivo=open('/home/jackie/Documentos/becarios_utna/ejercicios/Resultados/Dia5.csv','w')
    archivo.close()


def crearLatLong():
    archivo=open('/home/jackie/Documentos/becarios_utna/ejercicios/Resultados/LatLong.csv','w')
    archivo.close()
...
def mediaLatiLong():
    archivo=open('/home/jackie/Documentos/becarios_utna/ejercicios/Resultados/MediaLatiLong4.csv','w')
    archivo.close()


def writedia1():
    x=pd.DataFrame.to_csv(df1)
    archivo=open("/home/jackie/Documentos/becarios_utna/ejercicios/Resultados/Dia1.csv","a")
    archivo.write(x)
def writedia2():
    x=pd.DataFrame.to_csv(df2)
    archivo=open("/home/jackie/Documentos/becarios_utna/ejercicios/Resultados/Dia2.csv","a")
    archivo.write(x)
def writedia3():
    x=pd.DataFrame.to_csv(df3)
    archivo=open("/home/jackie/Documentos/becarios_utna/ejercicios/Resultados/Dia3.csv","a")
    archivo.write(x)
def writedia4():
    x=pd.DataFrame.to_csv(df4)
    archivo=open("/home/jackie/Documentos/becarios_utna/ejercicios/Resultados/Dia4.csv","a")
    archivo.write(x)
def writedia5():
    x=pd.DataFrame.to_csv(df5)
    archivo=open("/home/jackie/Documentos/becarios_utna/ejercicios/Resultados/Dia5.csv","a")
    archivo.write(x)

def writeLatLong():
    x=pd.DataFrame.to_csv(b)
    archivo=open("/home/jackie/Documentos/becarios_utna/ejercicios/Resultados/LatLong.csv","a")
    archivo.write(x)
...
def mediasDias():
    ...
    dtm5=str(dtm5)
    dtmin5=str(dtmin5)
    archivo=open("/home/jackie/Documentos/becarios_utna/ejercicios/Resultados/MediaLatiLong4.csv","a")
...
def mediasPorDia():
    ...
    dtm5=str(dtm5)
    dtmin5=str(dtmin5)
    archivo=open("/home/jackie/Documentos/becarios_utna/ejercicios/Resultados/MediaPorDias.csv","a")
...
def calcularUnidadesCalorBase10():
    ...
    archivo=open("/home/jackie/Documentos/becarios_utna/ejercicios/Resultados/UC.csv","a")
    archivo.write(x)
